<?php
    ...
    if (strlen($search_string) >= 1 && $search_string !== ' ') {
        ...
        $query = mysqli_query($sqllink, 'SELECT * FROM dnb4teh WHERE Name LIKE "%'.$search_string.'%" OR Poster LIKE "%'.$search_string.'%" ORDER BY datum DESC');
        ...
        $query = mysqli_query($sqllink, 'SELECT * FROM dnb4teh ORDER BY datum DESC');
