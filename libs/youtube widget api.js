(function () {
    ...
    var p = "closure_uid_" + (1E9 * Math.random() >>> 0), ca = 0;
    ...
    var v = Array.prototype, ga = v.indexOf ? function (a, b, c) {
    ...
    function ha(a, b) {
        ...
        t:{
            c = a.length;
            for (var d = n(a) ? a.split("") : a, e = 0; e < c; e++)if (e in d && b.call(void 0, d[e], e, a)) {
                c = e;
                break t
            }
            c = -1
    ...
    ;
    var z = -1 != y.indexOf("Opera") || -1 != y.indexOf("OPR"), A = -1 != y.indexOf("Trident") || -1 != y.indexOf("MSIE"), B = -1 != y.indexOf("Gecko") && -1 == y.toLowerCase().indexOf("webkit") && !(-1 != y.indexOf("Trident") || -1 != y.indexOf("MSIE")), C = -1 != y.toLowerCase().indexOf("webkit");
    ...
    function E(a) {
        ...
        if (!(b = pa[a])) {
            ...
            for (var c = fa(String(D)).split("."), d = fa(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                var k = c[f] || "", u = d[f] || "", kb = RegExp("(\\d*)(\\D*)", "g"), lb = RegExp("(\\d*)(\\D*)", "g");
                do {
                    var M = kb.exec(k) || ["", "", ""], N = lb.exec(u) || ["", "", ""];
    ...
    var qa = h.document, ra = qa && A ? oa() || ("CSS1Compat" == qa.compatMode ? parseInt(D, 10) : 5) : void 0;
    ...
    function Aa(a, b) {
        if (0 != a.B)a.k || (a.k = []), a.k.push(b); else {
            var c = a.d[b];
            if (c) {
                if (c = a.g[c]) {
                    var d = ga(c, b);
    ...
    g.R = function (a, b) {
        ...
        if (c) {
            ...
            this.B--;
            if (this.k && 0 == this.B)for (; c = this.k.pop();)Aa(this, c);
            return 0 != e
        }
        return!1
    };
    ...
    function Ea(a, b, c) {
        if ("array" == m(b))for (var d = 0; d < b.length; d++)Ea(a, String(b[d]), c); else null != b && c.push("&", a, "" === b ? "" : "=", encodeURIComponent(String(b)))
    }
    ...
    g.wheelDeltaX = 0;
    g.wheelDeltaY = 0;
    var Oa = {stopImmediatePropagation: 1, stopPropagation: 1, preventMouseEvent: 1, preventManipulation: 1, preventDefault: 1, layerX: 1, layerY: 1, scale: 1, rotation: 1};
    var x = l("yt.events.listeners_") || {};
    r("yt.events.listeners_", x);
    var Pa = l("yt.events.counter_") || {count: 0};
    ...
    function Ra(a, b, c) {
        if (a && (a.addEventListener || a.attachEvent)) {
            var d = Qa(a, b, c);
            if (!d) {
                var d = ++Pa.count + "", e = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter"in document), f;
                f = e ? function (d) {
                    d = new Na(d);
    ...
    function Sa(a) {
        a && ("string" == typeof a && (a = [a]), w(a, function (a) {
            if (a in x) {
                var c = x[a], d = c[0], e = c[1], f = c[3], c = c[4];
    ...
    function O(a, b, c) {
        ...
        this.M = {};
        b = document;
        if (a = n(a) ? b.getElementById(a) : a)if ("iframe" != a.tagName.toLowerCase() && (b = Za(this, a), this.o = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.d = a, this.d.id || (b = a = this.d, b = b[p] || (b[p] = ++ca), a.id = "widget" + b), K[this.d.id] = this, window.postMessage) {
            this.k = new H;
            $a(this);
            a = P(this.g, "events");
        ...
        window.location.href && w(["debugjs", "debugcss"], function (a) {
            ...
            i:{
                ...
                for (var e = a.length; 0 <= (d = b.indexOf(a, d)) && d < c;) {
                    ...
                    if (38 == f || 63 == f)if (f = b.charCodeAt(d + e), !f || 61 == f || 38 == f || 35 == f)break i;
                    d += e + 1
                }
                d = -1
            }
    ...
    g.N = function () {
        this.d && this.d.contentWindow ? this.J({event: "listening"}) : window.clearInterval(this.j)
    };
    function $a(a) {
        cb(a.g, a, a.G);
        a.j = La(q(a.N, a));
    ...
    g.J = function (a) {
        ...
        F(new va, a, b);
        a = b.join("");
        var b = this.g, c, d = Ca(this.d.src);
        c = d[1];
    ...
    var ob = fb, pb = gb, qb = hb, rb = ib, sb = jb, tb = mb, ub = nb;
    ...
    new xb;
    new xb;
    var T = y, T = T.toLowerCase();
    if (-1 != T.indexOf("android") && !T.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/)) {
        var yb = {cupcake: 1.5, donut: 1.6, eclair: 2, froyo: 2.2, gingerbread: 2.3, honeycomb: 3, "ice cream sandwich": 4, jellybean: 4.1}, zb = [], Ab = 0, Bb;
    ...
    var Db;
    var Eb = y, Fb = Eb.match(/\((iPad|iPhone|iPod)( Simulator)?;/);
    if (!Fb || 2 > Fb.length)Db = void 0; else {
    ...
    X.prototype.k = function (a) {
        var b;
        (b = a.origin == P(this, "host")) || ((b = a.origin) && b == wb ? b = !0 : (new RegExp("^(https?:)?//([a-z0-9-]{1,63}\\.)*(" + vb.join("|").replace(/\./g, ".") + ")(:[0-9]+)?([/?#]|$)", "i")).test(b) ? (wb = b, b = !0) : b = !1);
        if (b) {
            var c;
            try {
                c = ua(a.data)
    ...
    function Ob(a) {
        if ("iframe" != a.tagName.toLowerCase()) {
            var b = L(a, "videoid");
            if (b) {
                var c = L(a, "width"), d = L(a, "height");
                new Y(a, {videoId: b, width: c, height: d})
            }
        }
    }
    ...
    g.P = function (a) {
        ...
        switch (b) {
            case "apiInfoDelivery":
                if (ba(a))for (var c in a)this.t[c] = a[c];
                break;
            case "infoDelivery":
                Pb(this, a);
                break;
    ...
    function Pb(a, b) {
        if (ba(b))for (var c in b)a.A[c] = b[c]
    }
    ...
    g.aa = function () {
        var a = this.d.cloneNode(!1), b = this.A.videoData, c = P(this.g, "host");
    ...
    Z.prototype.C = function () {
        return{player: 0, thumb_width: P(this.g, "thumbWidth"), thumb_height: P(this.g, "thumbHeight"), thumb_align: P(this.g, "thumbAlign")}
    };
